...
- [CIFMA 2026](https://cifma.github.io), *8th International Workshop on Cognition: Interdisciplinary Foundations, Models and Applications*

  Organised by
  **Edoardo Datteri** (University of Milano-Bicocca, Italy) and
  **Stefano M. Nicoletti** (University of Twente, Netherlands).

- [ReacTS 2026](#), *3rd International Workshop on Reconfigurable Transition Systems: Semantics, Logics and Applications*

  Organised by
  **Daniel Figueiredo** (University of Aveiro, Portugal) and
  **Duncan Paul Attard** (University of Malta, Malta).

- [DataMod 2026](#), *14th International Symposium - From Data to Models and Back*

  Organised by
  **Ivan Compagnucci** (Gran Sasso Science Institute, Italy),
  **Silvia Giulia Galfrè** (University of Pisa, Italy), and
