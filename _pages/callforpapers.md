...
Regular papers may optionally submit artefacts, such as data sets, software tools, or supplementary material. Artefacts will be evaluated for the EAPLS Availability <img src="/2026/assets/artifact-available.png" width="50%" alt="SEFM Logo">, Functional, and Reusable badges. Authors should consult the [artefact submission guidelines](/2026/assets/artefact-submission-guidelines.pdf) when preparing their submission.
